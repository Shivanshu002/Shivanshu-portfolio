        ...
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between'>
          <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
            <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug'>
              Hi There, <br />I'm Shivanshu <span className='text-red-500'>Rajput</span>
            </h1>
            <p className='md:text-2xl text-xl mb-4'>Frontend Developer (Web & Mobile App) </p>
            <p className='mb-4'>
              I'm a passionate Frontend developer with expertise in React js, React Native, and modern web & mobile technologies. I love creating beautiful and functional websites and mobile apps that solve real-world problems.
            </p>
